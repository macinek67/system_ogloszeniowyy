<div class="container-lg">
    ...
    <div class="col-md-10 d-sm-flex d-block pt-4 m-auto">
        <div class="col-sm-4 text-center rounded-5 shadow-sm p-3 border mt-1 mt-sm-0 d-flex justify-content-center">
            <a href="#" class="h5 text-primary-emphasis my-auto">Najnowsze rekomendacje</a>
        </div>
        <div class="col-sm-4 text-center rounded-5 shadow-sm border p-2 mt-1 mt-sm-0 d-flex justify-content-center">
