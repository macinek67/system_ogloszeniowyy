<div class="w-100 justify-content-end">
    <div class="d-flex col-12 gap-2">
        ...
        <div class="d-md-flex d-none justify-content-center align-items-center col-4 rounded-4 shadow-sm p-2 border">
            <img class="col-xxl-10 col-xl-10 col-12" src="<?php echo IMAGE_URL; ?>mainPage_baner.webp">
        </div>
    </div>
</div>