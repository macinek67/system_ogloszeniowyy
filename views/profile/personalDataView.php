<form class="bg-light" method="post" action="">
    <div class="d-xl-flex d-lg-flex d-md-flex d-block">
        ...
        <div class="col-xl-8 col-lg-8 col-md-8 col-12 col-8 pt-xl-3 pt-lg-3 pt-md-3 pt-1 ps-xl-0 ps-lg-0 ps-md-0 ps-1 pe-xl-3 pe-lg-3 pe-md-3 pe-1">
            <div class="col pb-2">
                ...
                <input id="nameInput" type="text" value="Marcin" class="form-control" disabled>
            </div>
            <div class="col pb-2">
                <p class="h6 ms-1">Naziwsko:</p>
                <input id="surnameInput" type="text" value="Gawron" class="form-control" disabled>
            </div>
            <div class="col pb-2">
                <p class="h6 ms-1">Aktualne stanowisko:</p>
                <input id="currentOccupationInput" type="text" value="Początkujący programista" class="form-control" disabled>
            </div>
            <div class="col pb-3">
                <p class="h6 ms-1">Miasto:</p>
                <input id="cityInput" type="text" value="Kraków" class="form-control" disabled>
            </div>
            <div class="col float-xl-end float-lg-end float-md-end pb-3">
                <button id="personalDataEditButton" type="button" class="btn btn-secondary rounded-0 me-1" onclick="editData()">Edytuj</button>
