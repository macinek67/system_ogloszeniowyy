<form class="p-sm-5 p-2">
    <div class="p-2 ps-sm-5 pe-sm-5">
        <div class="text-center">
            ...
            <p class="text-primary-emphasis">Wpisz hasło dla <label class="fw-bold">tak@gmail.com</label>, aby się zalogować</p>
        </div>
        <div class="pt-3">
            <input required type="password" class="form-control pt-2 pb-2" placeholder="Hasło">
            <button type="button" class="btn-alt border-0 rounded-5 mt-4 p-3 w-100"><label class="h5 fw-bolder mb-0">Zaloguj się</i></label></button>
