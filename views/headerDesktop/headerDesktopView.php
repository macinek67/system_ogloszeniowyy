    ...
    <div class="container-xl">
        <div class="row pt-2 pb-2">
            <div class="col-xl-2 col-lg-2 col-md-12 col-12 text-center">
                <img class="h-100" src="http://localhost/system_ogloszeniowy/application_images/logo.webp">
            </div>
            ...
            <div class="col-xl-4 col-lg-4 d-xl-block d-lg-block d-none pt-1">
                ...
                <a href="#" class="h6 align-middle text-info-emphasis ms-5">Dodaj ogłoszenie</a>
            </div>
        </div>
    </div>
</header>
