<form class="offerContainer p-2" method="post" action="<?php echo ROOT_URL . "praca/oferta/" . $data["announcement_id"]; ?>">
    <button type="submit" class="offerButton border rounded-4 bg-white shadow-sm w-100 text-start p-0">
        ...
        <small class="ms-1 fw-bold text-secondary"><a href="<?php echo ROOT_URL . "konto/removeSaved/" . $data["saved_id"]; ?>" class="text-secondary text-decoration-none"><i class="h6 bi bi-x-lg align-middle"></i> usuń</a></small>
    </button>
</form>
