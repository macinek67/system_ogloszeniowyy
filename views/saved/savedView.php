...
<body>
    ...
    <div class="container-lg mt-4 mb-4">
        ...
        <div class="mt-4 bg-white shadow-sm rounded-4">
            <div class="p-3">
                <p class="h3 text-black fw-bolder">Zapisane ogłoszenia</p>
                <small class="h6 text-secondary fw-bolder">• Przeglądaj swoje wcześniej zapisane ogłoszenia!</small>
            </div>
            <hr>
